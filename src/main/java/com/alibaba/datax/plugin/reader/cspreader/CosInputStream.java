 ...
 */
public class CosInputStream extends InputStream {
     ...
     */
    public CosInputStream(final COSClient ossClient, final String bucket, final String object, long start, long end) {
        ...
        try {
            RetryUtil.executeWithRetry(new Callable<Boolean>() {
                ...
                public Boolean call() throws Exception {
                    COSObject ossObject = ossClient.getObject(getObjectRequest);
                    // 读取InputStream
            ...
            throw DataXException.asDataXException(
                    CosReaderErrorCode.RUNTIME_EXCEPTION,e.getMessage(), e);
        }
    }

    public CosInputStream(final COSClient ossClient, final String bucket, final String object) {
        this.ossClient = ossClient;
        this.getObjectRequest = new GetObjectRequest(bucket, object);
